...
const levels = [
    ...
    },
    {
        ...
        oncreate(game){
            ...
            game.create(-80, 0, 41, 42, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            game.create(42, 22, 18, 20, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            game.create(59, 29, 99, 13, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            game.create(106, 0, 52, 30, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            game.create(131, -16, 27, 14, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            game.create(14, -2, 2, 2, 'hopper', 'enemy', HopperEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(19, -1, 1, 1, 'hopper', 'enemy', HopperEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(10, -1, 1, 1, 'hopper', 'enemy', HopperEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(6, -1, 1, 1, 'hopper', 'enemy', HopperEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(23, -1, 1, 1, 'hopper', 'enemy', HopperEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
        ...
        onloop(game, framesElapsed){
            if (game.player.x < 20 * 50 || game.player.x > 24 * 50 || game.player.y > 30 * 50 || game.player.y < 23 * 50){
                ...
                game.ctx.fillRect(game.artOff.x + 20 * 50, game.artOff.y + 23 * 50, 4 * 50, 8 * 50);
            }
        },
        ondestroy(game){
    ...
    },
    {
        ...
        oncreate(game){
            ...
            game.create(-5, -3, 1, 8, 'glass', 'glass', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            game.create(44, 2, 1, 1, 'shooter', 'enemy', ShooterEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(58, 2, 1, 1, 'shooter', 'enemy', ShooterEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
