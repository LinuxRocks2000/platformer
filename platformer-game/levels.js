...
let levels = [ // If it's const, I can't dynamically add levels in Worker Levels.
    ...
    },
    {
        ...
        oncreate(game) {
            ...
            game.create(89, 79, 1, 1, "acid", "none", WeaponField, { weaponType: PrettyAverageSwordWeapon, retrieve: false });
            game.create(95, 79, 1, 1, "acid", "none", WeaponField, { weaponType: BasicGunWeapon, retrieve: false });
            ...
            game.create(178, 39, 1, 1, "acid", "none", WeaponField, { weaponType: MachineGunWeapon, retrieve: false });
    ...
    },
    {
        ...
        oncreate(game) {
            ...
            game.player.legacyGiveWeapon(PrettyAverageSword);*/
...
*/
    ...
    },
    {
        ...
        oncreate(game) {
            ...
            game.player.legacyGiveWeapon(PrettyAverageSword, true);
    ...
    },
    {
        ...
        oncreate(game) {
            ...
            game.player.legacyGiveWeapon(Hypersling);
            game.create(32, 0, 3, 10, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            game.create(-5, -6, 39, 10, 'water', 'water', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            //game.create(4, 3, 1, 1, "fish", "enemy", FishEnemy).isDamageable = false;
            game.player.score = 1000;
            function nunya(npc) {
                npc.glideToPlayer();
                npc.say("Then get OUT! Marcy, get him");
                game._create(npc.x, npc.y, game.blockWidth, game.blockHeight, "jumpthrough_", "enemy", PathfinderEnemy);
            }
            function cont(npc) {
                npc.speech = [
                    {
            ...
            game.create(10, 0, 1, 2, "harmless_npc", "none", LoreNPC, {
                name: "Maury the Hermit", speech: [
                    {
                        text: "Hey, what! Who are you? How did you get here?",
                        delay: 0,
                        prompt: [
                            {
                                text: "I went through the Portal to Heaven.",
                                fun: cont
                            },
                            {
    ...
    },
    {
        ...
        difficulty: 1,
        oncreate(game) {
            game.player.legacyGiveWeapon(BasicGun);
            game.startX = 0; // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.startY = -100; // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            if (this.isStairwayToHeaven) {
                if (this.isButton && !this.heaven) {
                    ...
                    for (var n = 0; n < 5; n++) {
                        ...
                        game.sign(x, y + 3, "", "Property of Maury the Hermit. Get out!");
                    ...
                    function nunya(npc) {
                        npc.glideToPlayer();
                        npc.say("Then get OUT! Marcy, get 'em!");
                        game._create(npc.x, npc.y, game.blockWidth, game.blockHeight, "jumpthrough_", "enemy", PathfinderEnemy);
                    }
                    function cont(npc) {
                        npc.speech.push({
                            ...
                            prompt: [
                                {
                                    text: "Anton needs solar cells.",
                                    fun: (npc) => {
                                        npc.speech.push({
                                            text: "Tell him if he wants solar cells he has to pay for them like everyone else!",
                                            delay: 0,
                                            prompt: [
                                                {
                                                    text: "Ok, I'll do that",
                                                    fun: () => {
                                                        game.quest = "anton_money";
                                                        npc.speech.push(
                                                            {
                                                                text: "There's an exit through the crack and to the right. Now get!",
                                                                delay: 300
                                                            }
                                                        );
                                                    }
                                                ...
                                                {
                                                    text: "I'll pay for it!",
                                                    fun: () => {
                                                        npc.speech.push(
                                                            {
                                                                text: "$500 coins. Can you afford that?",
                                                                delay: 0,
                                                                prompt: [
                                                                    {
                                                                        text: "Sure.",
                                                                        fun: () => {
                                                                            if (game.player.score >= 500) {
                                                                                game.player.collect(-500);
                                                                                npc.say("Here you are, 200 replacement solar cells. Pleasure doing business with you! There's an exit down and to the left.");
                                                                                game.quest = "anton_cells";
                                                                            }
                                                                            else {
                                                                                npc.say("Liar! You can't afford that! MARCY, GET 'EM!");
                                                                                game._create(npc.x, npc.y, game.blockWidth, game.blockHeight, "jumpthrough_", "enemy", PathfinderEnemy);
                                                                            }
                                                                        }
                                                                    },
    ...
    },
    {
        ...
        phase: -1,
        oncreate(game) {
            game.startX = -30.840736122176565; // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.startY = 134.78140841134032; // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(11, 24, 1, 5, 'pixel_kelp', 'none', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(6, 19, 1, 9, 'pixel_kelp', 'none', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-18, -20, 33, 21, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-51, -20, 34, 73, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-5, 5, 10, 20, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-18, 28, 35, 25, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-15, 24, 10, 1, 'glass', 'field', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-17, 24, 2, 1, 'jumpthrough', 'jumpthrough', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-8, 20, 3, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-17, 17, 2, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-9.794999999999998, 23, 1, 1, 'tank', 'enemy', TankEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-6, 14, 1, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-17, 12, 1, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-6, 10, 1, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-17, 7, 2, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-17, 25, 22, 3, 'water', 'water', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(5, 18, 9, 10, 'water', 'water', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(14, -20, 28, 34, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(14, 18, 11, 35, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-6, 19, 1, 1, 'mushroom', 'none', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-17, 16, 1, 1, 'rock', 'none', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(24, 24, 24, 29, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(35, 21, 1, 1, 'firespray', 'enemy', FiresprayEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(47, 18, 8, 35, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(38.46, 19, 3, 1, 'glass', 'glass', SideMovingPlatform); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(25, 20, 22, 4, 'pixel_lava', 'splenectifyu', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(51.321999999999996, 17, 1, 1, 'tank', 'enemy', TankEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(54, 15, 5, 11, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(47, 17, 1, 1, 'glass', 'field', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(41, -20, 25, 30, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(55, 14, 1, 1, 'coin', 'tencoin', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(63, 10, 1, 1, 'none', 'enemy', ShooterEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(65, -13, 18, 39, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(59, 25, 6, 1, 'jumpthrough', 'jumpthrough', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(59, 18, 1, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(64, 21, 1, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(54, 40, 20, 3, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(55, 32, 11, 8, 'pixel_lava', 'splenectifyu', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(67, 39, 12, 1, 'lava', 'killu', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(73, 40, 6, 18, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(80, -13, 16, 74, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(64, 60, 32, 24, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(66, 32, 1, 8, 'glass', 'glass', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(54, 62, 11, 22, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            
            game.create(70, 59, 1, 1, 'mine', 'enemy', ProximityMineEnemy);
            game.create(66, 59, 1, 1, "tar", "none", ChainBomb);
    ...
    },
    {
        ...
        oncreate(game) {
            game.startX = 50; // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.startY = 0; // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-13, 0, 1, 5, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(71, -2, 1, 7, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-45, 5, 143, 22, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-13, 5, 85, 2, 'dirt_medium', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-12, 6, 83, 1, 'dirt_empty', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(1, 2, 2, 3, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(2, 1, 3, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(3, -5, 4, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(7, -5, 7, 7, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(8, 2, 1, 3, 'glass', 'field', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(12, 2, 1, 3, 'glass', 'field', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(14, 1, 4, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(14, -3, 2, 1, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(10, -9, 3, 1, 'jumpthrough', 'jumpthrough', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(10, -9, 1, 4, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(7, -12, 2, 1, 'jumpthrough', 'jumpthrough', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(9, -12, 1, 4, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(22, 4, 1, 1, 'pixel_cannon', 'enemy', CannonEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-13, -1, 1, 1, 'pixel_cannon', 'enemy', CannonEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(11, -6, 1, 1, 'mushroom', 'none', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(70, -1, 1, 1, 'none', 'enemy', ShooterEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(57, 3, 1, 2, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(46, 2, 1, 3, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(37, -1, 1, 6, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(28, 4, 4, 1, 'lava', 'killu', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(41.265500000000166, 4, 1, 1, 'lava', 'enemy', NormalEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(44, -5, 1, 3, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(37, -9, 1, 4, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(45, -12, 1, 3, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(38, -15, 1, 2, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(44, -18, 1, 3, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-2, -21, 38, 3, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(35, 1, 2, 1, 'jumpthrough', 'jumpthrough', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(20, -18, 1, 23, 'glass', 'none', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(32, -18, 1, 23, 'glass', 'none', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(9, -18, 1, 6, 'glass', 'field', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-12, -24, 40, 4, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(-13, -43, 1, 42, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
        },
        onloop(game, framesElapsed) {
