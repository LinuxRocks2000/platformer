...
const levels = [
    ...
    },
    {
        ...
        oncreate(game){
            ...
            game.create(16, -1, 1, 2, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(17, -5, 3, 1, 'jumpthrough', 'jumpthrough', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(16, -6, 1, 2, 'normal', 'solid', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            ...
            game.create(16, -15, 1, 1, 'shooter', 'enemy', ShooterEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(19, -6, 1, 1, 'lava', 'enemy', NormalEnemy); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(16, -2, 1, 1, 'heal', 'heal', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(16, -7, 1, 1, 'heal', 'heal', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(18, -1, 1, 1, 'coin', 'fiftycoin', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.create(23, -6, 1, 1, 'coin', 'tencoin', Brick); // Autogenerated by Platformer Studio, a program built by Tyler Clarke.
            game.studio();
        },
        onloop(game, framesElapsed){
