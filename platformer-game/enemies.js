...
class ShooterEnemy extends Brick {
    ...
    loop(framesElapsed) {
        ...
        if (this.canSeePlayer()) {
            this.phase += framesElapsed;
            var distX = this.x + this.width / 2 - (this.targetPlayer.x + this.targetPlayer.width / 2);
            var distY = this.y + this.height / 2 - (this.targetPlayer.y + this.targetPlayer.height / 2);
        ...
        this.sendMultiplayerMessage(this.angle);
...
class CannonEnemy extends Brick {
    ...
    shoot() {
        this.game._create(this.x - this.game.blockWidth / 2 + this.width / 2 + ((this.targetPlayer.x < this.x ? -1 : 1) * this.game.blockWidth), this.y, this.game.blockWidth, this.game.blockHeight, (this.game.skin == "pixel" ? "pixel_cannonBall" : "bullet"), "bullet", BulletEnemy, {
            xv: ((this.targetPlayer.x < this.x ? -1 : 1) * 15),
            yv: 0,
            damage: 50
        });
    }
